...
# 用户个人信息头像
USER_USERINFO_PROFILE_AVATAR_INVALID = {'code': 1008, 'msg': '请上传正确的图片格式'}
USER_USERINFO_NAME_EXSITS = {'code': 1009, 'msg': '用户名已经存在'}

# 验证身份信息
USER_USERINFO_ID__NAME_CARD_INVALID = {'code': 1010, 'msg': '请填写完整的实名认证信息'}
USER_USERINFO_ID_CARD_INVALID = {'code': 1011, 'msg': '身份证信息错误'}

# 房屋模块
HOUSE_USER_INFO_ID_CARD_INVALID = {'code': 1100, 'msg': '用户没有实名认证'}
ORDER_START_END_TIME_ERROR = {'code': 1012, 'msg': '时间选择错误'}
